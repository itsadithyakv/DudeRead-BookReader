    ...
    <div className="flex min-h-full flex-col gap-10">
      ...
      <section className="paper-surface rounded-xl p-6">
        ...
        <div className="mt-8 space-y-6">
          <div
            className="rounded-xl border p-4 shadow-panel"
            style={{
          ...
          >
            ...
            {sortedSessions.length === 0 && (
              <div className="w-full rounded-lg border border-dashed border-outline-variant/40 p-6 text-sm text-on-surface-variant">
